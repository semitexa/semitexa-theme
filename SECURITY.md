...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-theme/security/advisories/new).
...
In scope: anything in `semitexa/theme` that lets a request, a job or a message do
